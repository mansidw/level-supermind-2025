...
const fetchBlogContent = async (email, blogId, language) => {
  try {
    const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/getBlog`, {
      email: email,
      blog_id: blogId,
      language: language
    }, {
...
const deleteBlog = async (blogId) => {
  try {
    const response = await axios.delete(`${process.env.NEXT_PUBLIC_BACKEND_URL}/deleteBlog/${blogId}`)
    return response.data
  } catch (error) {
...
const updateBlog = async (blogId, blogData) => {
  try {
    const response = await axios.put(`${process.env.NEXT_PUBLIC_BACKEND_URL}/updateBlog/${blogId}`, blogData)
    return response.data
  } catch (error) {
...
const toggleBlogPublish = async (blogId) => {
  try {
    const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/togglePublish/${blogId}`)
    return response.data
  } catch (error) {
